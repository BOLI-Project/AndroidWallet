...
public class CoinURI implements Serializable {
        ...
        if (type == null) {
            if (uri.getScheme() != null) {
                try {
                    ...
                    // uriScheme = possibleTypes.get(0).getUriScheme(); SB$ for coins with big&small letters
                    uriScheme = possibleTypes.get(0).getUriScheme().toLowerCase();
     ...
     * @return The {@link com.boli.core.coins.CoinType} of this URI
     */
