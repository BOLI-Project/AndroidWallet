...
import static com.boli.wallet.ExchangeRatesProvider.getRate;
...
public class AddressRequestFragment extends WalletFragment {
    ...
    public void updateView() {
        ...
        if (showAddress != null) {
            ...
            //receiveAddress = account.getReceiveAddress(); SB$ call with isManual..
            receiveAddress = account.getReceiveAddress(config.isManualAddressManagement());
        }
